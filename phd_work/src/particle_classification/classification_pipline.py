...
class ClassificationPipline(Pipline):
    def __init__(self, config, need_train_DS: bool = True,  many_val_loaders =False):
        ...
        self.device = 'cuda'
        self.model = Class_models.TransformerClassificationModel(encoder_path="/home/rfit/Telescope_Array/phd_work/src/train_VAE/test_particles/Pr_Phootn_latent_64latent_dim=64;_paticles=['pr', 'photon'];_/best",
                                                               **self.config)
