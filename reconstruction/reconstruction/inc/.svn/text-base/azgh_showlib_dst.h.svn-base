...
//
// azgh_showlib_dst.h DRB - 2008/09/18

#ifndef _AZGH_SHOWLIB_
#define _AZGH_SHOWLIB_

#define AZGH_SHOWLIB_BANKID      12801
#define AZGH_SHOWLIB_BANKVERSION   000

#ifdef __cplusplus
extern "C" {
#endif
integer4 azgh_showlib_common_to_bank_();
integer4 azgh_showlib_bank_to_dst_(integer4 *NumUnit);
integer4 azgh_showlib_common_to_dst_(integer4 *NumUnit); // combines above 2
integer4 azgh_showlib_bank_to_common_(integer1 *bank);
integer4 azgh_showlib_common_to_dump_(integer4 *opt1) ;
integer4 azgh_showlib_common_to_dumpf_(FILE* fp,integer4 *opt2);
...
} azgh_showlib_dst_common;

extern azgh_showlib_dst_common azgh_showlib_;
