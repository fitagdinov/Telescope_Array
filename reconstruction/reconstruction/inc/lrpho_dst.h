 ...
 * lrpho_dst.h
 *
 * $Source: /hires_soft/uvm2k/bank/lrpho_dst.h,v $
 * $Log: lrpho_dst.h,v $
...
#define LRPHO_BANKID 12205
#define LRPHO_BANKVERSION 0 

#ifdef __cplusplus
extern "C" {
#endif
integer4 lrpho_common_to_bank_(void);
integer4 lrpho_bank_to_dst_(integer4 *NumUnit);
integer4 lrpho_common_to_dst_(integer4 *NumUnit); /* combines above 2 */
...
extern lrpho_dst_common lrpho_ ; 
