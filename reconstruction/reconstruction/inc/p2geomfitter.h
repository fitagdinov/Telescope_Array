#ifndef P2GEOMFITTER_H_
#define P2GEOMFITTER_H_
...
#define P2GEOMFITTER_MNFPARS 6 // max. # of fit parameters
...
#define P2GEOM_TEMP_dr 0.15 // error on barycentric core location
...
#define P2GEOM_DCHI2 4.0

// Max. number of iterations for minuit
#define P2GEOM_MITR 50000


class p2geomfitter_class
{
 public:
  ...
  integer4 cleanClust(real8 deltaChi2 = P2GEOM_DCHI2);
  integer4 doFit(integer4 whatFCN);
  // Checks if the last call to fitter converged
  bool hasConverged();
  p2geomfitter_class();
  virtual ~p2geomfitter_class();
